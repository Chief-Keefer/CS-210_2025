...
public class Term implements Comparable<Term> {
    ...
    private static class PrefixOrder implements Comparator<Term> {
        ...
        public int compare(Term v, Term w) {
            // Get prefixes of length r (or the whole query if shorter)
            String vPrefix = v.query.length() < r ? v.query : v.query.substring(0, r);
            String wPrefix = w.query.length() < r ? w.query : w.query.substring(0, r);
